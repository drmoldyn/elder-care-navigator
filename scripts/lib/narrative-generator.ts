  ...
  private generateFAQs(data: EnhancedMetroData, tiers: TierDistribution): MetroNarrative['faqs'] {
    ...
    return [
      ...
      },
      {
        ...
        answer: `Key observations: (1) Staff interactions - are they attentive and kind? (2) Resident appearance - clean, groomed, engaged? (3) Facility odors - fresh or concerning smells? (4) Cleanliness throughout common areas and rooms. (5) Activity level - residents participating in programs? Red flags: ${tiers.lower > 0 ? `Facilities with 1-2 star health inspections (${tiers.lower} in ${data.city})` : 'Facilities with recent violations'}, immediate availability when others have waitlists, evasive answers about staffing, strong odors, or unkempt residents. Visit at varying times including evenings and weekends.`,
        category: 'quality',
      },
      {
